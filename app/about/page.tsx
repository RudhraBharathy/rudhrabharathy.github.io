  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 text-black dark:text-white p-4 md:p-6">
      <main className="max-w-6xl mx-auto">
        <h1 className="text-[8rem] md:text-[12rem] font-bold leading-none">About</h1>

        <div className="bg-gray-200 dark:bg-gray-800 p-6 md:p-10 rounded-lg mb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <div className="mb-6">
                <p className="uppercase text-sm font-medium mb-1">CURRENTLY SOLVING PROBLEMS</p>
              ...
              <div className="space-y-4">
                <p>
                  I&apos;m Rudhra Bharathy. I&apos;m passionate about creating things that are useful, beautiful, and
                  make a difference. I enjoy working on projects that challenge me to learn and grow, whether it&apos;s
                  designing, building, or problem-solving.
                </p>
                <p>
                  I focus on delivering quality work, paying attention to detail, and always looking for better ways to
                  do things. I&apos;m a quick learner, a good team player, and someone who loves what they do.
                </p>
              </div>
            </div>
